    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teacher_id', models.CharField(blank=True, max_length=20, null=True, unique=True, verbose_name='教师工号')),
                ('department', models.CharField(blank=True, max_length=100, null=True, verbose_name='院系/部门')),
